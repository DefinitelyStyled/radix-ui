...
export const AccordionDemo: React.FunctionComponent<AccordionDemoProps> = ({ className }) => {
    return (
        <Accordion type="single" defaultValue="item-1" collapsible className={className}>
